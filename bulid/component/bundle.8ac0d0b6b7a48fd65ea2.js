...
var _searchInfo = __webpack_require__(111);
...
var _foodNav = __webpack_require__(115);

var _foodNav2 = _interopRequireDefault(_foodNav);

var _foodList = __webpack_require__(114);
...
var _cartView = __webpack_require__(113);

var _cartView2 = _interopRequireDefault(_cartView);

var _shopInf = __webpack_require__(118);
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(_cart2.default, { data: this.state.resInf, count: this.state.orderCount, price: this.state.orderPrice, fn: this.showCartView.bind(this) })
				),
				_react2.default.createElement(
					'div',
...
var _weather = __webpack_require__(121);
...
var _searchInp = __webpack_require__(119);

var _searchInp2 = _interopRequireDefault(_searchInp);

var _restaurant = __webpack_require__(65);
...
var _sortNav = __webpack_require__(123);
...
var _rem = __webpack_require__(104);

var _rem2 = _interopRequireDefault(_rem);

var _iconfont = __webpack_require__(105);
	...
	_createClass(Cart, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					"div",
					{ className: "shop-send", style: { background: dif > 0 && !that.props.count ? '#ccc' : '#0096ff' } },
					dif > 0 && !that.props.count ? '还差￥' + dif + '起送' : '马上配送'
				)
			);
		}
	}]);
...
var _food = __webpack_require__(108);
...
var _reactSwipe = __webpack_require__(235);
...
var _sortOptions = __webpack_require__(124);
...
var _swipeJsIso = __webpack_require__(250);
